...
// padding a string (to add number of characters until the string has a certain desired length)
...
console.log(maskCreditCard(29082930480));
console.log(maskCreditCard(43378463864647384));
console.log(maskCreditCard('029372075894257239048'));
...
// for cases where the property is 0
rest1.numGuests ??= 10;
rest2.numGuests ??= 10;
